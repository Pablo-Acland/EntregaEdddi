            ...
            <div className="detail_main">
                ...
                <div className="text">
                    ...
                    <div className="text_content">
                        <h3>{ (moreInfo && moreInfo.length > 0)   ? moreInfo : `Lo sentimos no tenemos mas informacion por el momento`}</h3>
                    </div>
                            ...
                            <div className="avatar-group">
                                {
                                    ...
                                    :(<div className="warning_text">En este momento no tenemos creadores para mostrar</div>)
                                }
                            </div>
                        </div>
                    </div>
